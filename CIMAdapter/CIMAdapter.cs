					...
					case SupportedProfiles.PowerTransformer:
						{
							...
							TransformAndLoadReport report = ProfileImporter.Instance.CreateNMSDelta(concreteModel);

							if (report.Success)
							{
								nmsDelta = ProfileImporter.Instance.NMSDelta;
								success = true;
							}
							else
							{
							...
							ProfileImporter.Instance.Reset();
